...
## 8. ייצוא רכזים וגנים (Coordinators & Gardens Export)
...
- **סינון לפי מפעיל / ספק**: מאפשר להפיק דוח רכזים הכולל **אך ורק גנים שבהם פועל המפעיל הנבחר**. בעמודת ההערות מוצג יום ושעת החוג של המפעיל באותו הגן (למשל: `חוג תלתן · ימי ג' 14:00`). רכזים ללא גנים למפעיל זה מסוננים החוצה.
- **טבלת עריכת גילאים מרוכזת לפי עיר (`garden-age-batch-m`)**: ממשק טבלאי מהיר להזנת גילאי כל הגנים ברצף לפי עיר, עם תמיכה במקשי חצים / Enter למעבר מהיר בין שורות, כפתורי תגיות גיל מהירים (`3-4`, `4-5` וכו'), ושמירה אוטומטית מקומית וב-Firebase.
- **פורמטי ייצוא**:
  1. **ExcelJS**: עיצוב עברי RTL מלא, כותרת עליונה מעוצבת לפי מפעיל/רכז, כותרות עמודות קפואות, עמודת גיל מובנית, סימון מספרי טלפון, וגיליונות נפרדים לכל רכז.
