...
- **פורמטי ייצוא**:
  1. **ExcelJS**: עיצוב עברי RTL מלא, כותרת עליונה מעוצבת, כותרות עמודות קפואות, סימון מספרי טלפון, וגיליונות נפרדים לכל רכז במידת הצורך.
  2. **WhatsApp / הודעה**: פורמט טקסטואלי נקי ומסודר לפי ערים עם פרטי רכז, כתובות וטלפון הגן (אם קיים).
