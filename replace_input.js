...
const target = `      <!-- Inline Add Task Row -->
...
const newRow = `      <!-- Chat Input Area (WhatsApp style) -->
...
code = code.replace(target, newRow);

fs.writeFileSync('worker_tasks.js', code);
console.log("Successfully replaced inline row with WhatsApp style input row.");
